...
public class BodyDoubleRenderer
    ...
    private final HumanoidModel<BodyDoubleEntity> wideModel;
    private final HumanoidModel<BodyDoubleEntity> slimModel;
    ...
    @Override
    public void render(BodyDoubleEntity entity, float entityYaw, float partialTick,
